                            ...
                            <form id="msform" class="form" action="thank-you.php?" novalidate method="post">
                                ...
                                <fieldset id="form-step4" class="form-steps fieldset-3" data-step="4" style="display: none;" data-tag="zip">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="state" class="form-control state" type="text" name="state" title="Enter Your state" placeholder="Enter Your State Name" value="Florida" required>
