...
<head>
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-KWW3RGHZ');
    </script>
...
<body class="v2-page en">
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KWW3RGHZ" height="0" width="0" style="display:none;visibility:hidden"></iframe>
    </noscript>
                            ...
                            <form id="msform" class="form" action="thank-you.php?" novalidate method="post">
                                ...
                                <fieldset id="form-step2" class="form-steps fieldset-1" data-step="2" style="display: none;" data-tag="zip">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="zip" class="form-control zipcode" type="tel" name="zip_code" pattern="[0-9]{5}" title="Enter Your ZIP Code" maxlength="5" minlength="5" placeholder="Enter Your ZIP Code" value="" required>
...
document.getElementById("q11-next").addEventListener("click", function() {
                ...
                <div class="row" style="justify-content: center;">
                    <div class="footer-menu">
                        <div id="footer" class="form-group">
                            <p id="tcpa_label">
                                Copyright&copy; 2024&nbsp;cleversolartechs.com&nbsp;All Rights Reserved &nbsp;<a href="privacy.php" target="_new">Privacy policy</a> || <a href="terms.php" target="_new">Terms and
                                    Conditions</a> || <a href="ccpa.php" target="_new">CCPA</a> || <a href="contact_us.php" target="_new">Contact
                                    Us</a>
                            </p>
                            <style>
                                footer {
            ...
            <div class="tcpa-content-container">
                ...
                <div id="companylist-php" class="hidden">
                    ...
                    <p>
                        ...
                        Energy<br>Infinity Solar<br><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="167f7870795624272465797a77643875797b">[email&#160;protected]</a><br>Initiate
                        ...
                        Solar<br>Modern Day Pros<br><a href="https://hs.leadpost.net/clientList.jsp?c_level=default&aff=0" target="_blank">Modernize</a><br>Mohr Power<br>Momentum<br>Momentum
    ...
    <noscript><img src='//create.leadid.com/noscript.gif?lac=95D8E963-466E-8BEC-A6C5-E0410876431F&lck=da4f95aa-f083-ef71-3e7b-e2ad17d60006&snippet_version=2' />
    </noscript>
